    ...
    publisher = OutboxPublisher(
        ...
        config=OutboxPublisherConfig(
            ...
            topics_by_event_type={
                ...
                "OrderConfirmationRequested": settings.kafka_order_events_topic,
                "OrderConfirmed": settings.kafka_order_events_topic,
                "OrderRejectionRequested": settings.kafka_order_events_topic,
                "OrderCancellationRequested": settings.kafka_order_events_topic,
                "OrderCancelled": settings.kafka_order_events_topic,
                "OrderProcessingFailed": settings.kafka_order_events_topic,
                "StockFinalizationRequested": settings.kafka_stock_commands_topic,
                "StockReleaseRequested": settings.kafka_stock_commands_topic,
            },
        ),
        worker_id=worker_id,
    )
